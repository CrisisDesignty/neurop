...
about:
  ...
  description: "Centro neurop es un espacio clínico dedicado al apoyo diagnóstico y la intervención neuropsicológica."
  stats:
    - title: "¿Quiénes somos?"
      description: "Centro neurop es un espacio clínico dedicado al apoyo diagnóstico y la intervención neuropsicológica."
    - title: "Nuestro objetivo"
      description: "Comprender de manera integral el funcionamiento cognitivo, emocional y conductual de cada persona, para orientar estrategias de apoyo individualizadas que mejoren su calidad de vida y su participación en los distintos entornos."
    - title: "Trabajamos con"
      description: "Familias, Médicos, Terapeutas, Escuelas"
  callout:
    text: "Todas nuestras evaluaciones son realizadas por neuropsicólogas especialistas certificadas en los instrumentos internacionales de referencia para el diagnóstico y nuestras intervenciones se diseñan a partir de evidencia científica actualizada."
    button_text: "Especialistas"

services:
  - title: "Evaluación neuropsicológica"
    description: "Proceso clínico especializado para identificar fortalezas y áreas de dificultad en funciones cognitivas, conductuales y emocionales."
    color: "#0891B2"
    filter: "evaluacion-neuropsicologica"
  - title: "Evaluación de lenguaje"
    description: "Valoración integral de la comprensión, expresión y uso funcional del lenguaje oral y no verbal."
    color: "#65A30D"
    filter: "evaluacion-lenguaje"
  - title: "Terapia de comunicación, habla y lenguaje"
    description: "Intervención dirigida al desarrollo y fortalecimiento de habilidades comunicativas, incluyendo Comunicación Aumentativa y Alternativa (CAA)."
    color: "#7C3AED"
    filter: "terapia-comunicacion"
  - title: "Terapia de aprendizaje"
    description: "Espacio terapéutico centrado en la mejora de procesos cognitivos y académicos asociados a lectura, escritura y matemáticas."
    color: "#D97706"
    filter: "terapia-aprendizaje"
  - title: "Terapia emocional"
    description: "Atención psicológica enfocada en el manejo de emociones, regulación conductual y desarrollo de recursos personales."
    color: "#DB2777"
    filter: "terapia-emocional"
  - title: "Formación y asesoría especializada"
    description: "Ofrecemos pláticas, cursos y asesoría a equipos escolares y terapéuticos sobre detección y estrategias de intervención."
    color: "#059669"
    filter: "all"
...
Welcome to our neuropsicología center homepage.